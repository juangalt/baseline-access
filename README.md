...
```bash
curl -fsSL https://raw.githubusercontent.com/juangalt/baseline-access/v0.3.4/baseline-access.sh | bash
```
...
<https://github.com/juangalt/baseline-access/blob/v0.3.4/baseline-access.sh>.
